...
# Submit your PR on this new repo [Hacktoberfest](https://github.com/thevirus69/Pro-Code) , There we are merging all PR. 

In this current repo, there are alot of conflicts, we are not merging until all conflicts get resolved.
Hacktoberfest { [Live Website](https://thevirus69.github.io/Pro-Code/)}
...
```terminal
git remote add upstream https://github.com/thevirus69/Pro-Code
```
